...
},{"process":"TKp0"}],"BQVr":[function(require,module,exports) {
"use strict";
...
var init = function init(el) {
  new _View.default({
    ...
    render: function render(data) {
      ...
      (0, _jquery.default)(this.html.replace('{{n}}', data.n)).appendTo(this.el);
    },
    events: {
      'click #add1': 'add',
      'click #minus1': 'minus',
...
var _default = init;
exports.default = _default;
},{"./app1.css":"KmRI","jquery":"juYr","./base/Model.js":"wYwp","./base/View":"SFHW"}],"vZ5o":[function(require,module,exports) {
"use strict";
...
var _default = init;
exports.default = _default;
},{"./app2.css":"KmRI","jquery":"juYr","./base/Model":"wYwp","./base/View":"SFHW"}],"y8lT":[function(require,module,exports) {
"use strict";
...
var init = function init(el) {
  new _View.default({
    ...
    eventBus: eventBus,
    data: m.data,
    html: function html(bool) {
      return "\n            <div>\n                <div class=\"".concat(bool === 'no' ? 'square active2' : 'square', "\"></div>\n            </div>\n        ");
    },
    render: function render(data) {
      if (this.el.children().length !== 0) this.el.empty();
      (0, _jquery.default)(this.html(data.bool)).appendTo(this.el);
    },
    events: {
      'click .square': 'move'
    },
    move: function move() {
      var bool = m.data.bool === 'no' ? 'yes' : 'no';
      m.update({
        bool: bool
      });
    }
...
var _default = init;
exports.default = _default;
},{"./app3.css":"KmRI","jquery":"juYr","./base/Model":"wYwp","./base/View":"SFHW"}],"eWpN":[function(require,module,exports) {
"use strict";
...
var v = {
  ...
  render: function render(bool) {
    ...
    (0, _jquery.default)(v.html(bool)).appendTo(v.el);
  }
};
var c = {
  init: function init(container) {
...
//# sourceMappingURL=main.30cd6519.js.map